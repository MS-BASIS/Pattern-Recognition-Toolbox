...
[Pcl,Tcl,Lcl,rcl,cXcl] = robpcasvd(data);
clasmean=cXcl;
        ...
        for i=1:nsamp
            ...
            if ~Hsets_ind
                ...
                elseif fine
                    ...
                    [P,T,L,r,meanvct] = robpcasvd(data(index,:));
                    if r==0
                        ns = 1;
                        rew.center=meanvct;
                        rew.cov=zeros(p,p);
            ...
            if ~ns
                for j=1:csteps
                    ...
                    [P,T,L,r,meanvct] = robpcasvd(data(obs_in_set,:));
                    if r==0
                        rew.center=meanvct;
                        rew.cov=zeros(p,p);
...
[P,T,L,r,cX] = robpcasvd(data(bestset,:));
...
[telobs,indobs] = sort(teller(1:(end - 1)),'descend');
